...
For data product, medallion architecture, or Lakehouse tasks, the Data Product Accelerator provides a **Design-First Pipeline** with 50 agent skills. Read `data_product_accelerator/AGENTS.md` for the full routing table.
