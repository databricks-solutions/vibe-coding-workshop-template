...
**First read:** [`gc-prompt-conversion/GENIE-CODE-OVERRIDES.md`](gc-prompt-conversion/GENIE-CODE-OVERRIDES.md) — maps CLI / `npm` / localhost patterns in skills to MCP + SDK patterns that work in notebooks.

## Run the workshop (Genie)

1. **Workspace prep:** [PRE-REQUISITES.md](../PRE-REQUISITES.md) (foundation). **MCP admin:** [pre-req-mcp-setup.md](../pre-req-mcp-setup.md) before participants run [`prompts/mcp-setup-gc.md`](prompts/mcp-setup-gc.md).
...
4. **Errors:** [`gc-prompt-conversion/troubleshooting_gc.md`](gc-prompt-conversion/troubleshooting_gc.md).
5. **MCP tool reference:** [`gc-prompt-conversion/MCP-appkit_tooling.md`](gc-prompt-conversion/MCP-appkit_tooling.md).
