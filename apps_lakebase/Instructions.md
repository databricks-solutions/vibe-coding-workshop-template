...
1. **Workspace prep:** [PRE-REQUISITES.md](../PRE-REQUISITES.md) (foundation). **Optional MCP admin** (not required for the standard SDK track): [pre-req-mcp-setup.md](../pre-req-mcp-setup.md) and [`prompts/mcp-setup-gc.md`](prompts/mcp-setup-gc.md).
...
5. **Optional MCP reference:** [`gc-prompt-conversion/MCP-appkit_tooling.md`](gc-prompt-conversion/MCP-appkit_tooling.md).
