...
| Canonical live file — Pathways A, B, C | `apps_lakebase/$APP_NAME/.vibecoding-state.md` |
| Canonical live file — Pathway D (agent only) | `agents/$AGENT_NAME/.vibecoding-state.md` |
